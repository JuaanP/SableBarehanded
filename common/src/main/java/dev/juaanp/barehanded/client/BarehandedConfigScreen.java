...
public class BarehandedConfigScreen {
    ...
    private static void buildRotation(ConfigCategory server, ConfigEntryBuilder eb) {
        ...
        addBoolean(rotation, eb, "Camera Locked Rotation Y (Yaw)", "Grabbed object maintains its facing relative to you when you turn (always on by default).", ServerConfig.INSTANCE.cameraLockedRotationY, SERVER_DEFAULTS.cameraLockedRotationY, v -> ServerConfig.INSTANCE.cameraLockedRotationY = v);
