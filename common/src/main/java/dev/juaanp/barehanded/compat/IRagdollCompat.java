...
public interface IRagdollCompat {
    ...
    boolean containsRagdollBlocks(ServerSubLevel subLevel);
    ...
    boolean canGrabSubLevel(Player player, ServerSubLevel subLevel);
    ...
    IRagdollCompat NOOP = new IRagdollCompat() {
        ...
        @Override public boolean containsRagdollBlocks(ServerSubLevel subLevel) { return false; }
        ...
        @Override public boolean canGrabSubLevel(Player player, ServerSubLevel subLevel) { return true; }
    };
}